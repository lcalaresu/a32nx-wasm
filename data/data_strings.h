...
const PCSTRINGZ pcstring_lSimVars[totalRealLVarsCount][2] = {
    //===============================ELEC======================
        ...
        {"PACK1_TURB_BYPASS_POS", "Percent"},
        {"PACK2_TURB_BYPASS_POS", "Percent"},
        {"PACK1_FLOW_RATE", "Percent"},
        {"PACK2_FLOW_RATE", "Percent"},
        {"PACK1_FLOW_CONTROL_VALVE_POS", "Percent"},
        {"PACK2_FLOW_CONTROL_VALVE_POS", "Percent"},
        {"CKPT_TEMP", "Celsius"},
        {"FWD_TEMP", "Celsius"},
        {"AFT_TEMP", "Celsius"},
        {"CKPT_DUCT_TEMP", "Celsius"},
        {"FWD_DUCT_TEMP", "Celsius"},
        {"AFT_DUCT_TEMP", "Celsius"},
        {"CKPT_TRIM_VALVE_POS", "Percent"},
        {"FWD_TRIM_VALVE_POS", "Percent"},
        {"AFT_TRIM_VALVE_POS", "Percent"},
        {"HOT_AIR_VALVE_POS", "Percent"},
        {"MIXER_UNIT_OUT_FLOW_RATE", "Percent"},
